            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="grid grid-cols-2 gap-2 md:flex md:justify-start">
                <Button
                  ...
                  className="gap-2 whitespace-nowrap text-sm md:text-sm w-full md:w-auto md:h-9 md:px-3"
                >
                  <Shuffle className="h-4 w-4 md:h-3 md:w-3" />
                  Random Topic
                </Button>
                <Button 
                  type="submit" 
                  size="lg" 
                  className="gap-2 text-sm md:text-sm w-full md:w-auto md:h-9 md:px-3"
                >
                  {isGenerating ? (
                    <>
                ...
                {currentGeneratedPoem && (
                  <div className="space-y-4">
                    <div className="bg-accent/10 p-4 md:p-6 rounded-lg relative">
                      ...
                      <p className="text-foreground whitespace-pre-line leading-relaxed pr-12 max-w-2xl">
                        {currentGeneratedPoem}
                      </p>
                    </div>
                    {user && (
